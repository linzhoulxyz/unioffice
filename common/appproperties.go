...
import (
	...
	"github.com/linzhoulxyz/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/linzhoulxyz/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/linzhoulxyz/unioffice
